...
var dotenvExpand = require('./lib/dotenvExpand')

function printHelp () {
  console.log([
    'Usage: dotenv [--help] [--debug] [-e <path>] [-p <variable name>] [-c [environment]] [-o] [-- command]',
    '  --help              print help',
    ...
    '  -o | --override     override system wide environment variables',
